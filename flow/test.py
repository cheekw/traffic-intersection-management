...
class FourWayIntersectionNetwork(Network):
    ...
    def specify_edges(self, net_params):
        return [
            {"id": "north_to_center", "from": "north_end", "to": "center", "length": 50, "numLanes": 1, "speed": 1},
            {"id": "south_to_center", "from": "south_end", "to": "center", "length": 50, "numLanes": 1, "speed": 1},
            {"id": "east_to_center",  "from": "east_end",  "to": "center", "length": 50, "numLanes": 1, "speed": 1},
            {"id": "west_to_center",  "from": "west_end",  "to": "center", "length": 50, "numLanes": 1, "speed": 1},
            {"id": "center_to_south", "from": "center", "to": "south_end", "length": 50, "numLanes": 1, "speed": 1},
            {"id": "center_to_north", "from": "center", "to": "north_end", "length": 50, "numLanes": 1, "speed": 1},
            {"id": "center_to_east",  "from": "center", "to": "east_end", "length": 50, "numLanes": 1, "speed": 1},
            {"id": "center_to_west",  "from": "center", "to": "west_end", "length": 50, "numLanes": 1, "speed": 1}
        ]
